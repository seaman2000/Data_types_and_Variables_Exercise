...
The tasks are designed to practice:
- Basic syntax
- Data types and variables
- Conditional statements
- Loops
- ASCII table operations
- Logical and state-based problem solving

The main goal is **understanding the logic and writing clean code**, not just passing the judge.
